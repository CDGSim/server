...
final class WeatherTests: XCTestCase {
    func testQNH() throws {
        let weather = DecorController.Weather(from:"Q1033")
    ...
    func testWindWithStrongWind() throws {
        let weather = DecorController.Weather(from:"120170KT")
        XCTAssertEqual(weather.windDirection, 120)
        XCTAssertEqual(weather.windSpeed, 170)
    }
    
    func testWindWithGust() throws {
        let weather = DecorController.Weather(from:"12017G35KT")
        XCTAssertEqual(weather.windDirection, 120)
        XCTAssertEqual(weather.windSpeed, 17)
    ...
    func testSampleMETAR2() throws {
        let weather = DecorController.Weather(from:"Q1015 24005KT BKN040 M01/M05 R27L/1500")
    ...
    func testRVR() throws {
        let weather = DecorController.Weather(from:"R27R/1500 R08L/1000 R09R/900 R26L/750")
